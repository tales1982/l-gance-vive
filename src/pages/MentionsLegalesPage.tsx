...
const MentionsLegalesPage = () => (
  <div className="container py-8 max-w-3xl">
    ...
    <div className="prose prose-invert prose-sm max-w-none space-y-6 text-muted-foreground">
      ...
      <p>Sveltia SAS<br />12 Rue de la Sérénité, 75008 Paris<br />Capital social : 10 000 €<br />RCS Paris : XXX XXX XXX<br />Numéro de TVA : FR XX XXX XXX XXX</p>
      ...
      <p>L'ensemble des contenus du site Sveltia (textes, images, vidéos, logos) sont protégés par le droit de la propriété intellectuelle. Toute reproduction, même partielle, est strictement interdite sans autorisation écrite préalable.</p>
