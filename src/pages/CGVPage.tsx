...
const CGVPage = () => (
  <div className="container py-8 max-w-3xl">
    ...
    <div className="prose prose-invert prose-sm max-w-none space-y-6 text-muted-foreground">
      <p>Les présentes Conditions Générales de Vente (CGV) régissent l'ensemble des ventes réalisées sur le site Sveltia. En passant commande, le client déclare avoir pris connaissance et accepté sans réserve les présentes conditions.</p>
      <h2 className="font-display text-lg font-semibold text-foreground">Article 1 — Objet</h2>
      <p>Les présentes CGV définissent les droits et obligations des parties dans le cadre de la vente en ligne de compléments alimentaires et accessoires de bien-être proposés par Sveltia.</p>
      <h2 className="font-display text-lg font-semibold text-foreground">Article 2 — Prix</h2>
      <p>Les prix sont indiqués en euros toutes taxes comprises (TTC). Sveltia se réserve le droit de modifier ses prix à tout moment, mais les produits seront facturés sur la base des tarifs en vigueur au moment de la validation de la commande.</p>
      ...
      <p>Les délais de livraison sont donnés à titre indicatif. Sveltia s'engage à expédier les produits dans un délai de 24 à 48 heures ouvrées à compter de la confirmation de la commande.</p>
